...
builder.Services.AddScoped<IAuthorizationHandler, RepairOperationRequirementHandler>();
builder.Services.AddScoped<IAuthorizationHandler, TechnicalReviewOperationRequirementHandler>();
builder.Services.AddScoped<IAuthorizationHandler, InsuranceOperationRequirementHandler>();
